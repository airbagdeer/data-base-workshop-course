...
We chose the technilgies for the same reasons as written in the client:
...
We also just wanted to learn this technology, as its a standard for modern web development.
...
\subsection{The Data Access Layer (DAL)}
