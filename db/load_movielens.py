...
def load_movielens(conn, cur):
    print('Loaded MovieLens Data Set')
...
def load_ml_movies(conn, cur):
    ...
    insert_ml_movies_query = "INSERT INTO movies (movieId, title, genres) VALUES (%s, %s, %s)"
...
def load_ml_ratings(conn, cur):
    ...
    insert_ml_ratings_query = "INSERT INTO ratings (userId, movieId, rating , rating_time) Values (%s, %s, %s, %s)"
...
def load_ml_links(conn, cur):
    ...
    insert_ml_links_query = "INSERT INTO links (movieId, imdbId, tmdbId) VALUES (%s, %s, %s)"
